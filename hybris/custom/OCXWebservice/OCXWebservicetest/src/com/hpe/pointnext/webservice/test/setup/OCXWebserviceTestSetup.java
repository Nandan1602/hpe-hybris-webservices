 ...
 */
package com.hpe.pointnext.webservice.test.setup;
...
public class OCXWebserviceTestSetup extends AbstractSystemSetup
{
	...
	private static final Logger LOG = Logger.getLogger(OCXWebserviceTestSetup.class);
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		getSetupImpexService().importImpexFile("/OCXWebservicetest/import/sampledata/user-orders.impex", true, false);
	...
	{
		return Config.getBoolean("OCXWebservicetest.enableWsIntegrationTest", false);
	}
	...
	protected void loadOptionalSampleData(final List<String> storeNames)
	{
		...
		{
			storeNames.forEach(store -> getSetupImpexService().importImpexFile(String.format("/OCXWebservicetest/import/acceleratorwebservicesaddon/%s/solr.impex", store), true, true));
		}

		if (extensionNames.contains("yacceleratorfulfilmentprocess"))
		{
			getSetupImpexService().importImpexFile("/OCXWebservicetest/import/orderprocess/store.impex", true, true);
		}
	}

	public void initializePromotionEngineModule()
	{
		getSetupImpexService().importImpexFile("/OCXWebservicetest/import/promotionengine/promotionsmodule.impex", true,
				false);
	}
	...
	protected void loadIntegrationData()
	{
		...
		{
			getSetupImpexService().importImpexFile("/OCXWebservicetest/import/integration/cis-integration-data.impex", true);
		}

		if (extensionNames.contains("omssampledata"))
		{
			getSetupImpexService().importImpexFile("/OCXWebservicetest/import/integration/oms-integration-data.impex", true);
		}
	}
	...
	protected void loadMultiDimensionalData()
	{
		getSetupImpexService().importImpexFile(
				"/OCXWebservicetest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-categories.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/OCXWebservicetest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products.impex", true,
				false);
		getSetupImpexService().importImpexFile(
				"/OCXWebservicetest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-prices.impex",
				true, false);
		getSetupImpexService()
				.importImpexFile(
						"/OCXWebservicetest/import/sampledata/productCatalogs/wsTestProductCatalog/dimension-products-stock-levels.impex",
						true, false);
