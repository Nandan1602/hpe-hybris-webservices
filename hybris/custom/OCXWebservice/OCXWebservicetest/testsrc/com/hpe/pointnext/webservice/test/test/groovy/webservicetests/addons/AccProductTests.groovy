 ...
 */
package com.hpe.pointnext.webservice.test.test.groovy.webservicetests.addons
...
import com.hpe.pointnext.webservice.test.test.groovy.webservicetests.v1.BaseWSTest
...
class AccProductTests extends BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("OCXWebservicetest.enableAccTest", false)
				&& Config.getBoolean("OCXWebservicetest.enableV1", false))
	}
