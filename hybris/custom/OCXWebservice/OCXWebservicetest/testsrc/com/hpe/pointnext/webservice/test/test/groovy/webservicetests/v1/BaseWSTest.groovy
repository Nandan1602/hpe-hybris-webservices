...
import com.hpe.pointnext.webservice.test.test.groovy.webservicetests.TestNamePrinter
import com.hpe.pointnext.webservice.test.test.groovy.webservicetests.TestUtil
import com.hpe.pointnext.webservice.test.test.groovy.webservicetests.config.TestConfigFactory
import com.hpe.pointnext.webservice.test.test.groovy.webservicetests.docu.BaseWSTestWatcher
...
class BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("OCXWebservicetest.enableV1", false))
	}
	...
	protected BaseWSTest() {
		config = TestConfigFactory.createConfig("v1", "/OCXWebservicetest/groovytests-property-file.groovy");
