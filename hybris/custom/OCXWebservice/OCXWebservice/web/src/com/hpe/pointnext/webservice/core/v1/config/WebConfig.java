 ...
 */
package com.hpe.pointnext.webservice.core.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.hpe.pointnext.webservice.core.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "OCXWebservice.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "OCXWebservice.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "OCXWebservice.oauth2.tokenUrl";

	private static final String DESC = "OCXWebservice.v1.description";
	private static final String TITLE = "OCXWebservice.v1.title";
	private static final String VERSION = "OCXWebservice.v1.version";
